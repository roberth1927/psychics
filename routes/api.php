...
Route::prefix('v1')->group(function () {
    ...
    //search routes
    Route::get('search/psychics', 'Api\SearchController@getPsychics')->name('psychics');
    ...
    Route::get('search/model/{slug}', 'Api\SearchController@getModel')->name('model');
    ...
    Route::get('search/reportcosmic', 'Api\SearchController@getReportCosmic')->name('reportcosmic');
    ...
    Route::get('get/languages','Api\PsychicController@getLanguages')->name('get/languages');

    Route::get('/psychic/transactions', 'Api\PsychicController@getCreditLog')->name('psychic_transactions');
...
Route::group(['middleware' => 'auth:api'], function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::get('/psychic/payouts/pending', 'Api\AdminController@getPayoutsPendingAmount')->name('admin.payout.pending');
