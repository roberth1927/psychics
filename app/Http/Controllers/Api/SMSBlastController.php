...
class SMSBlastController extends Controller
{
    ...
    public function sendSmsMarketing()
    {
        ...
        foreach ($users_actives as $user) {
            ...
            $message = $user->user_profile->name.", holding up ok? With Psychics1on1, comfort is a click away. Get answers, support and heal. Talk to your Psychic now: psychics1on1.com";
            // $message = "How do you feel in this moment? It’s ok to be scared or confused, you’re not alone. Find your calm, get answers. Talk to your Psychic now: psychics1on1.com";
