...
class AppointmentController extends Controller
{
    ...
    protected function filterAppointments(Request $request)
    {
        ...
        $q = Appointment::where('psychic_id', '=', Auth::guard('api')->user()->id);
    ...
    public function getAppointmentsMonth(Request $request)
    {
        ...
        $field = $user->role_id == WhiteLabel::roleId('Psychic') ? 'psychic_id' : 'user_id';
    ...
    public function createAppointment(Request $request)
    {
        ...
        if ($now_or_later == 'later') {
            ...
            // EmailUtils::send_to_psychic_when_user_request_service($appointment_aux, $now_or_later);
            // TwilioUtils::send_sms_when_user_create_appointment($appointment_aux, $now_or_later);
            //     broadcast(new NotificationsInAppEvent([

            //         'appointment'=>new AppointmentScheduledRequestResource($appointment_aux),
            //         'pid'=>$appointment_aux->psychic->id]))->toOthers();
        }else{
