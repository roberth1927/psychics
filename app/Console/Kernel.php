...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('email:no_logged_in_30_day')->dailyAt('12:00');
        $schedule->command('email:purchase_credits_1')->dailyAt('12:00');
        $schedule->command('email:purchase_credits_2')->dailyAt('12:00');
        $schedule->command('email:weekly_hroscope_manual')->weeklyOn(1, '12:00')->timezone('America/New_York');
        $schedule->command('email:weekly_horoscope_sign_email')->weeklyOn(1, '12:00')->timezone('America/New_York');
        $schedule->command('sms:phone_weekly_horoscope_sign')->weeklyOn(1, '12:00')->timezone('America/New_York');
        $schedule->command('email:specialties_30_day')->dailyAt('12:00');
        $schedule->command('email:10_day_after_client_register')->dailyAt('12:00');
        $schedule->command('email:20_day_after_client_register')->dailyAt('12:00');
        $schedule->command('email:45_day_after_client_register')->dailyAt('12:00');
        $schedule->command('email:send_psychics_top_rate')->twiceMonthly(1, 15, '12:00')->timezone('America/New_York');
        $schedule->command('email:send_psychics_feature')->twiceMonthly(7, 28, '12:00')->timezone('America/New_York');
        $schedule->command('email:14daysTips')->dailyAt('12:00');
        $schedule->command('email:7daysSuccess')->dailyAt('12:00');
        $schedule->command('email:24_hour_after_register')->dailyAt('12:00');
        $schedule->command('sms:24_hour_phone_verification')->dailyAt('12:00');
        $schedule->command('email:send_birthday_gift')->dailyAt('12:00');
