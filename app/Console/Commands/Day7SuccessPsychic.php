    ...
    public function handle()
    {
      ...
      //  $users = User::where('email_validated', 1)
          $users = User::where('test_user', 0)
            ...
            $texts = ['Clients love a little face-to-face before booking a reading. Plus, intro media means you get priority visibility (and more clients!).', 'Summing yourself up in a 50 character phrase isn’t easy, but makes a world of difference in how many clients end up on your page (grab their attention!).', 'This means when someone searches your Psychics1on1™ display name, they’ll see your elevator pitch and even click right through to your profile!'];
