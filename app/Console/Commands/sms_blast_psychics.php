...
class sms_blast_psychics extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($users as $user) {
            ...
            if($number){
                $message = "Psychics1on1 will be featured on ExtraTV tomorrow! Tune in for our exclusive interview and share the exciting news as we kickstart marketing in a big way!";
