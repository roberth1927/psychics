...
class spanishPsychicsNotification extends Command
{
     ...
     * @var string
     */
    protected $description = 'Spanish Psychics Notification';
    ...
    {
        //list of psychics
        $psychics = User::where('email_validated', 1)->where('role_id', 1)->get();
        //$psychics = User::where('email_validated', 1)->where('role_id', 1)->where('email', 'osnielcainzo@gmail.com')->get();

        foreach ($psychics  as $user) {
