    ...
    public function handle()
    {
        ...
        foreach ($users as $user) {
            ...
            if($number && $number->number != "" && !is_null($number->number) && !empty($number->number)){
                ...
                $message = "Psychics1on1 is on TV! Watch our exclusive interview on ExtraTV tomorrow, and find our featured Psychics for your next reading psychics1on1.com/?m=".$code;
