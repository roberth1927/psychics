    ...
    public function handle()
    {
        ...
        foreach ($users as $user) {
            ...
            if($number && $number->number != "" && !is_null($number->number) && !empty($number->number) && $number->validated){
                ...
                $message = "We’ve got a new look! Browse our psychics to see more robust profiles with detailed information about the services they offer: ".route('home').'?f='.$code;
