        ...
        $users = User::where('email_validated', 1)->where('id', '>', 74)->get();
            ...
            foreach ($users as $user) {
                ...
                if($number->validated == 1) {
                    $message = "This is the sign you've been looking for... say hello to your Horoscope Hub! Get your free weekly horoscope on demand @Psychics1on1 psychics1on1.com/horoscope";
