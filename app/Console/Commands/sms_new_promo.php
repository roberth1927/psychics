    ...
    public function handle()
    {
        ...
        foreach ($users as $user) {
            ...
            if($number && $number->number != "" && !is_null($number->number) && !empty($number->number) && $number->validated){
                ...
                $message = "Get $5 free with your next purchase! Apply the promo by purchasing through this link: psychics1on1.com/?mc=".$code;
        ...
        foreach ($psychics as $psychic) {
            ...
            if($number && $number->number != "" && !is_null($number->number) && !empty($number->number) && $number->validated){
                $code = rand(1000, 99999);
                $message = "You spoke and we listened - as of today the “First Message Free” promo is officially over! psychics1on1.com/?pl=".$code;
