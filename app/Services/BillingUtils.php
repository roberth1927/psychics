...
class BillingUtils
{
    ...
    public static function get_user_cards($user_id, $card, $all = false)
    {
                ...
                foreach ($customer->billing as $cust) {
                    ...
                    switch ($card) {
                        ...
                        case 'DEPOSIT':
                            ...
                            'id'=>$id,'priority'=>$priority, 'routing'=>$routing,'account_name'=> $check_name, 'bank_name' => $bank_name,'payment'=>'DEPOSIT','country'=>$country];
                           /* array_push($customersArrayT, $customerArray);
                            array_push($ids, $id);*/
