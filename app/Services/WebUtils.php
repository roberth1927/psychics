...
class WebUtils {
    ...
    public static function sendGclid($data)
    {
        ...
        $mycurl = curl_init();
        //$postStr = 'gclid =' . $data['gclid'] . '&signup=' . $data['signup']. '&first_purchase=' . $data['first_purchase']. '&amount=' . $data['amount'];
        //$url = "https://hooks.zapier.com/hooks/catch/489836/byedwrn/?" . $postStr;
        $url = "https://hooks.zapier.com/hooks/catch/489836/byedwrn/";
        curl_setopt($mycurl, CURLOPT_URL, $url); // Set POST URL
        curl_setopt($mycurl, CURLOPT_POSTFIELDS, $postRequest);
        curl_setopt($mycurl, CURLOPT_SSLVERSION, 6);
        curl_setopt($mycurl, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($mycurl, CURLOPT_CONNECTTIMEOUT, 15);
        curl_setopt($mycurl, CURLOPT_TIMEOUT, 150);
