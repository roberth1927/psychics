  ...
  <div>
    <v-container v-if="mobile">
      <v-row justify="start" class="mb-6">
        <h1
          class="h3 mb-0 mt-1"
          style="color:#A163C1; padding-left: 15px;"
        >Browse Our Menu of Online Psychic Specialties</h1>
      </v-row>
    ...
    <v-container v-else>
      <v-row justify="start" class="mb-6">
        <h1 class="h3 mb-0" style="color:#A163C1;">Browse Our Menu of Online Psychic Specialties</h1>
      </v-row>
