                ...
                >
                  <div class="row">
                    <div
                      ...
                      style="min-height: 22px;white-space: nowrap;text-overflow: ellipsis;overflow: hidden;"
                    >
                  ...
                  <div class="row mt-2">
                    <div class="col-7" style="padding: 0px 3px !important;">
           ...
           <v-hover v-slot:default="{ hover }">
              ...
              >
                ...
                >
                  ...
                  <div class="row mt-2">
                    <div class="col-7" style="padding: 0px 3px !important;max-height:34px;">
                      <span v-for="(cat, index) in item.categories">
                        <img v-if="index < 4" :src="cat.path" />
                      </span>
                    </div>
