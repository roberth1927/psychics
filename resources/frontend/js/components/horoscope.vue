        ...
        <v-container class="p-0">
          ...
          >
            ...
            <p
              ...
              "
            >
              Feeling as if you need more support in this crazy life? The Psychics1on1™ top-rated online psychics can perform a tailored horoscope reading online for your star sign offering insight into your personality and valuable information about your future. You can then use this knowledge to improve your relationships, your career, your finances, and more. Book a reading with any of our psychics or check out our free horoscopes to get you started on the path you were always meant to be on.
            </p>
          </div>
        </v-container>
      </v-flex>
        ...
        <swiper v-if="$vuetify.breakpoint.xsOnly"
         ...
         ref="mySwiper3" :options="swiperOptions3" class="row">
          ...
          <div class="cols-12 col-md-6" >
            ...
            <a :href="'/blog/category/'+cati.slug" class="m-auto" v-for="(cati,index) in i.categories" :key="cati.cat_name" :style="$vuetify.breakpoint.smAndDown ? 'margin-bottom: 10px !important;' : 'margin-bottom: 15px !important;'" style="color: #A2A2A2; font-size: 12px; text-align: left;">
              <span :id="'cat' + index" style="    font-size: 12px;    padding-right: 4px;
    letter-spacing: 0.24px;font-weight: 600;
    line-height: 22px;    margin: 15px 0px;
    color: #43425D;
    opacity: 1;"> <span v-if="index > 0">|</span> {{cati.name}}</span>
            </a> 
