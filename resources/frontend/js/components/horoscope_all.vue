      ...
      <v-row class="">
        ...
        >
          <v-hover v-slot:default="{ hover }" class="ability_card" >
            ...
            @click="!mobile ? '' :  changeActive(index); "
            ...
            style="text-decoration: none">
              ...
              >
                ...
                >
                  ...
                  <img
                    :alt="item.name + ' Zodiac Sign'"
                    :src="'/images/horoscopes/link_'+ item.logo"
                    style="display:none;"
                  />
                </v-col>
...
export default {
  ...
  methods: {
      changeActive(index) {
          document.getElementById("img"+index).src = "/images/horoscopes/link_"+this.horoscopes[index].logo;
          setInterval(() => {
          document.getElementById("img"+index).src = "/images/horoscopes/"+this.horoscopes[index].logo;
          }, 500);        
     },
