<template>
  <div>
    <section style="background: #fff">
      <div class="container">
        <SignPageLogos v-if="!$vuetify.breakpoint.xs"/>
        <div class="row">
        ...
        <div class="row" style="margin-bottom: 50px">
          <div
            class="sfSign"
            :class="$vuetify.breakpoint.xsOnly ? 'col-12' : 'col-6'"
            :style="[
              $vuetify.breakpoint.xsOnly ? { order: '1' } : { order: '0' },
            ]"
          >
            <h2>Why Join Psychics1on1.com</h2>
            <h3>Top Quality Network</h3>
            <p>
              Our top-tier network of experienced and compassionate
              professionals is here to give you the direct attention you
              deserve.
            </p>

            <h3>Always Available</h3>
            <p>
              Anywhere in the world, anytime of day - our experts are here for
              you when you need them the most. Providing best in class readings,
              answers and advice.
            </p>
            ...
            <p>
              Our growing gallery of Psychics, Mediums, Healers and Astrologers
                  ...
                  <div class="col-12 px-3">
                    <div class="card-body px-0 pt-8">
                      <form method="POST" action class="registration_form">
                              ...
                              >
                                ...
                                >
                                  <span style="line-height: 18pt"
                                    >uppercase letter, number & special
                                    character required</span
                                  >
                                </span>
                                <span
                                  class="float-right text-danger"
                        ...
                        <div class="form-row mb-0">
                          <div
                            class="col-md-12 col-12 col-sm-12 col-lg-12 mb-3"
                          >
                            <div class="form-row m-0">
                              <div
                                class="col-md-12 col-12 col-sm-12 col-lg-12 pl-0 pr-0"
                              >
                                <v-checkbox
                                  ...
                                  width: 88%;"
                                  v-model="user_new.subscribe_horoscope"
                                  hide-details
                                >
                                  <template v-slot:label>
                                    <div style="
                                      ...
                                      font-weight: 400;
                                      line-height: 12pt;">
                                      Subscribe to the FREE Horoscope Newsletter.
                                    </div>
                                  </template>
                                </v-checkbox>
                              </div>
                            ...
                            <div class="form-row m-0">
                              ...
                              >
                                ...
                                <label
                                  ...
                                  "
                                >
                                  By signing up, you certify that you are 18
                                  years old or older, and agree to our
                                  <a
                                    style="color: #a2a2a2"
                                    target="_blank"
                                    href="/terms"
                                    >Terms & Conditions</a
                                  >. You consent to receive SMS messages and emails from
                                  Psychics1on1™ to provide updates on your
                                  account and/or for marketing purposes. You
                                  will receive up to 5 promotional messages or emails a
                                  month. Reply “STOP” to cancel at any time.
          ...
          <div class="col mb-5" v-if="$vuetify.breakpoint.xs">
            <SignPageLogos/>
          </div>
        </div>
...
<script>
import SignPageLogos from './signup_page_logos.vue'
export default {
  props: ["country_all", "link_psychic"],
  components: {SignPageLogos},
  data() {
    return {
      errors1: [],
      errors: [],
  ...
  methods: {
    ...
    registerUser() {
      ...
      axios
        ...
        .then((res) => {
          if (res.status == 201) {
            if (this.link_psychic) {
              window.location = "/"+this.link_psychic;
            }else{
