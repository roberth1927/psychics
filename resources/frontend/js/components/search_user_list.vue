    ...
    <v-container class="pb-0" style="margin-bottom: 26px;">
      <v-row no-gutters class="d-flex justify-center">
        <v-col class="d-flex align-end" :sm="10" cols="10" :lg="6" :md="6">
          <label style="color: #43425D; font-weight: 600;" class="mb-0 searchTitleFont ml-n2">{{title && title !== "" ? title + " Advisors" : "Advisors Based On Your Search"}}</label>
        </v-col>
          ...
          <v-menu offset-y v-model="open">
            ...
            <v-list>
              <v-list-item
                ...
                @click="sort = item;"
              >
                <v-list-item-content class="pb-0" style="color: #A163C1; text-align:center">
                  <v-list-item-title>
        ...
        >
          <v-hover v-slot:default="{ hover }">
              ...
              >
                ...
                <v-card-text style="background:#ffffff;border-radius:20px;font-size:10px;padding:10px!important; position:absolute; bottom:0;max-height:116px !important;">
                  <div class="row">
                    <div class="col-12 text-center tagline--text" style="min-height: 22px;white-space: nowrap;text-overflow: ellipsis;overflow: hidden;">
