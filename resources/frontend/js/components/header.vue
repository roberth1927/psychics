  ...
  <div>
    <div class="fixed_header_container">
      ...
      >
        ...
        <div class="row">
          ...
          <div class="col-2 text-center"><a href="/#Specialties" @click="scrollPage()"  class="white--text mr-10">Specialties</a></div>
    ...
    >
      ...
      <i
        ...
        <a v-else-if="item.title == 'Abilities'"  :href="'/abilities/'+child.slug">
          <v-list-item-content class="pl-7">
            <v-list-item-title v-text="child.name"></v-list-item-title>
          </v-list-item-content>
        </a>
...
export default {
  ...
  mounted() {
    ...
    {
      this.explore_icon = "/images/icons/Explore_Icon_40x40.svg";
    } 
