...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'profile.description' => [
            'min' => 'The background cannot be less than 200 characters.',
            'max' => 'The Background may not be greater than 400 characters.',
            'regex' => 'Background may only contain letters and numbers.'
        ],
        // Call Rate
        'user_services.0.rate' => [
            'required' => 'Service rate is required.',
            'required_if' => 'Service rate is required.',
            'min' => 'Call rate must be at least $1.50',
        ...
        'user_services.1.rate' => [
            'required' => 'Service rate is required.',
            'required_if' => 'Service rate is required.',
            'min' => 'Chat rate must be at least $0.75 a message.',
        ...
        'profile.birth_date' => [
            'before' => "You must be 18+ to use Psychics1on1™",
            'date_format' => 'Please enter a valid date',
            'required' => 'Please enter a valid date'
        ],
        'age' => [
            'accepted' => "You must be 18+ to use Psychics1on1™"
        ],
