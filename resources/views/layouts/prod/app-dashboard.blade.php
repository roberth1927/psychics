...
<script type="text/javascript">
    ...
    <script  src="{{ asset('backend/js/app.js') }}?id=120720211302" defer></script>

    <!-- Web Manifest -->
    <link rel="manifest" href="{{ env('APP_URL') }}/manifest.json">
    <!-- Styles -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@mdi/font@5.x/css/materialdesignicons.min.css">
    <link rel="stylesheet" href="{{ asset('backend/css/app.css') }}?id=120720211302">
    <link rel="stylesheet" href="{{ asset('css/custom.css') }}?id=120720211302">
