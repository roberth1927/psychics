...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; ">
  <center role="article" aria-roledescription="email" lang="en" style="width: 100%;">
    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="750"
        ...
        <td class="padding-sm"
         ...
         <![endif]-->
          ...
          <div
            ...
            <div style="padding-top: 15px;padding-bottom: 5px; font-family: 'Montserrat', 'Verdana', sans-serif;">About these top-rated psychics!</div>
          </div>
        </td>
      </tr>
      @php
      ...
      @php
      $review = $reviewsUser[$cont++]; // \App\Models\Review::find($user1->review);// $user1->reviews()->orderBy('rating', 'desc')->first();
                ...
                <div style="color: #9D61BD; font-size: 14px; padding-top: 11px">
                  <span
                    style="color: #656B72; font-size: 12px; font-weight: 600; font-family: 'Montserrat',  'Verdana', sans-serif; padding-right: 10px;
                      max-width: 120px;white-space: nowrap;overflow: hidden !important;text-overflow: ellipsis;display: inline-block;">
                    {{$review->title}}
                  </span>
