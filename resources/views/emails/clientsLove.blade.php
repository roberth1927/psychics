    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="750"
      ...
      <tr>
        <td class="hidden-sm" style="height: 270px; background-size: cover; background-repeat: no-repeat; vertical-align: top;
          background-position: center; background-image: url('{{config('app.url')}}/images/emails/clients_love_desktop.png')">
            <center style="padding-top:35px;padding-bottom: 50px">
        ...
        <td class="show-sm td-show-sm" style="height: 230px; background-size: cover; background-repeat: no-repeat; vertical-align: top;
          background-position: center;background-image: url('{{config('app.url')}}/images/emails/clients_love_mobile.png')">
            <center style="padding-top:5px;padding-bottom: 65px">
              <a href="{{config('app.url')}}">
      ...
      <tr>
        <td style="background:#43425D; padding: 30px 20px 20px 20px">
          <div style="line-height: 24px; text-align: center; font-size: 16px; color:#FFFFFF;max-width: 550px; margin: 0 auto">
            Stop wasting your time sitting on the couch or waiting for someone to sweep you off your feet. Take action by finding the right one for you. If you don’t know where to start, then let one of our love and relationship psychics guide you in your journey.
          </div>
        </td>
      </tr>
      <tr>
        <td style="padding-top: 20px; background:#F0F0F7;">
          <div style="text-align: center; font-size: 16px; color:#43425D; font-weight: 600; ">
            Our Top Relationship Psychic Picks
          </div>
        </td>
      </tr>
