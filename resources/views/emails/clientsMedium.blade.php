    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="750"
      ...
      <tr>
        <td class="hidden-sm" style="height: 270px; background-size: cover; background-repeat: no-repeat; vertical-align: top;
          background-position: center;background-image: url('{{config('app.url')}}/images/emails/clients_medium_desktop.jpg')">
        ...
        <td class="show-sm td-show-sm" style="height: 230px;background-size:cover;background-repeat:no-repeat;vertical-align:top;
          background-position:center;background-image: url('{{config('app.url')}}/images/emails/clients_medium_mobile.png')">
      ...
      <tr>
        <td style="padding-top: 20px;background:#43425D;">
            <div style="font-size:16px; text-align: center;font-weight: 600;color:#FFFFFF;">Receive The Closure You Deserve</div>
          </div>
        </td>
      </tr>
      <tr>
        <td style="background:#43425D; padding: 30px 20px 20px 20px">
          <div style="line-height: 24px; text-align: center; font-size: 16px; color:#FFFFFF;max-width: 550px; margin: 0 auto">
            Multiple versions of reality can cloud our judgment. It can lead us to a downward spiral. Take back your power today. Mediums can help you during a critical decision.
          </div>
        </td>
      </tr>
      <tr>
            ...
            <tr style="height: 169px">
              ...
              <td class="content-right" style="background-color: #FFFFFF; text-align: left; padding: 20px 20px 10px 18px;">
                ...
                <div style="font-size: 12px; text-align: right; color: white;">
                  <!--[if !gte mso 9]> -->
                  <a style="font-weight: 600; display: inline-block; padding: 10px 20px; padding-right: 5px; background-color: #43425D; border-radius: 20px; color:white; font-size: 12px; font-family: 'Montserrat',  'Verdana', sans-serif;"
