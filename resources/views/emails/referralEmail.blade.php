    ...
    <center role="article" aria-roledescription="email" lang="en" style="width: 100%;">
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="750"
            ...
            <tr>
                <td>
                    <div class="hidden-sm"
                        style="width: 100%; height: 472px; background-size: cover; background-repeat: no-repeat; background-image: url('https://www.psychics1on1.com/images/site-images/referral.gif'); text-align: center;">
                    ...
                    <div class="show-sm"
                        style="width: 100%; height: 305px; background-size: cover; background-repeat: no-repeat; background-image: url('https://www.psychics1on1.com/images/site-images/referral_mobile.gif'); text-align: center;">
                        <div style="margin-bottom: 40px;padding-top: 40px">
                            <a href="https://www.psychics1on1.com/">
                                <img src="https://www.psychics1on1.com/images/site-images/logo.png" width="159" />
                            </a>
            ...
            <tr>
                <td
                    ...
                    <div
                        ...
                        <div class="font-change"
                            style="font-family: 'Montserrat', 'Verdana', sans-serif; padding-left: 25px; padding-right: 25px; line-height: 1.5; max-width: 550px; margin: auto; font-weight: 600;">
                            {!!ucfirst(strtolower($user->userProfile->name))!!}
                        </div>
                    </div>

                    <div
                        style="max-width: 550px; margin: auto; font-family: 'Montserrat',  'Verdana', sans-serif; color: #43425D; font-size: 16px ">
                        Thought you’d love Psychics1on1, a new platform connecting you to the world’s most gifted psychics, mediums, healers and astrologers.
                    </div>
            ...
            <tr>
                <td
                    ...
                    <div
                        ...
                        <div class="font-change"
                            style="font-family: 'Montserrat', 'Verdana', sans-serif; padding-left: 25px; padding-right: 25px; line-height: 1.5; max-width: 550px; margin: auto; font-weight: 600;">
                            Get $10 Free With Your First Purchase!
                        </div>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <td
                    ...
                    <div
                        style="max-width: 550px; margin: auto; font-family: 'Montserrat',  'Verdana', sans-serif; color: #43425D; font-size: 16px ">
                        Tap below to sign up as my guest and you’ll automatically receive $10 free with your first purchase of $10 or more.
                    </div>
                    <div style=" margin-top: 30px; height: 30px; width: 100%;text-align:center;"><a
                            ...
                            href="https://www.psychics1on1.com/join/{{$user->userProfile->profile_link}}"
                            target="blank">
                            <span style="color:#FFFFFF; font-family: 'Montserrat', 'Verdana', sans-serif;">Sign Up</span>
                        </a></div>
