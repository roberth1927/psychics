    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="750"
      ...
      <tr>
        <td class="hidden-sm" style="height: 343px; background-size: cover; background-repeat: no-repeat; vertical-align: top;
          background-position: center; background-image: url('{{config('app.url')}}/images/emails/clients_love_desktop_new.png')">
            <center style="padding-top:35px;padding-bottom: 10px">
              <a href="{{config('app.url')}}">
                <img src="{{config('app.url')}}/images/site-images/logo.png" width="165" /></a>
              </center>
              <div style="
                float: right;
                max-width: 375px;
              ...
              ">
                <p style="
                  ...
                  margin-bottom: 15px;
                  color: #FFFFFF;"
                >Attract Your<br/>Next Partner<br/></p>
                ...
                <a href="https://www.psychics1on1.com/signup"><div style="
                  margin: auto;
        ...
        <td class="show-sm td-show-sm" style="height: 230px; background-size: cover; background-repeat: no-repeat; vertical-align: top;
          background-position: center;background-image: url('{{config('app.url')}}/images/emails/clients_love_mobile_new.png')">
            <center style="padding-top:5px;padding-bottom: 10px">
              <a href="{{config('app.url')}}">
                <img src="{{config('app.url')}}/images/site-images/logo.png" width="135" /></a>
              </center>
              <div style="
                float: right;
                max-width: 285px;
      ...
      <tr>
        <td style="padding-top: 20px;background:#43425D;">
            <div style="font-size:18px; text-align: center;font-weight: 600;color:#FFFFFF;">Find The Right One For You</div>
          </div>
        </td>
      </tr>
      <tr>
        <td style="background:#43425D; padding: 10px 20px 10px 20px;">
          <div style="line-height: 24px; text-align: center; font-size: 16px; color:#FFFFFF;max-width: 550px; margin: 0 auto; font-family: 'Montserrat', 'Verdana', sans-serif; font-weight:400 !important;">
            Let our love and relationship psychics guide you in your journey.
          </div>
        </td>
      </tr>
      <tr>
        <td style="padding-top: 20px; background:#F0F0F7;">
          <div style="text-align: center; font-size: 16px; color:#43425D; font-weight: 600; ">
            Relationship Psychics We Think You'll Love!
          </div>
        </td>
      </tr>
              ...
              <td class="content-right" style="background-color: #FFFFFF; text-align: left; padding: 20px 20px 10px 18px;">
                <div style="display:flex; align-items:center">
                  <div style="padding-right: 10px;" class="show-sm">
                    <div style="background:url('{{config('app.url')}}/images/emails/profile/{{$user1['image']}}'); border-radius: 50%; width: 60px; height: 60px;
