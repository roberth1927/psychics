            ...
            <tr>
                <td
                    ...
                    <div style="padding: 40px; 0px">
                        <!--[if !gte mso 9]> -->
                        <a style="font-weight: 600; width: 114px; height: 38px; padding: 10px 20px; background-color: #A163C1; border-radius: 20px; color:white; font-size: 14px; font-weight: 600; font-family: 'Montserrat', 'Verdana', sans-serif;"
                        ...
                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{config('app.url')}}/dashboard/profile" style="height:38px;v-text-anchor:middle;width:130px;" arcsize="60%" opacity="0" stroke="f" fillcolor="#A163C1">
                        <w:anchorlock/>
