    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="750"
      ...
      <tr>
        <td class="hidden-sm" style="height:343px;background-size:cover;background-repeat:no-repeat;vertical-align:top;
          background-position:center;background-image:url('{{config('app.url')}}/images/emails/clients_financial_desktopn.png')"><!--{{config('app.url')}}-->
            <center style="padding-top:5px;padding-bottom: 38px">
              <a href="{{config('app.url')}}">
                <img src="{{config('app.url')}}/images/site-images/logo.png" width="159" /></a><!--{{config('app.url')}}-->
              </center>
              <div style="
                float: right;
                max-width: 285px;
        ...
        <td class="show-sm td-show-sm" style="height:229px;background-size:cover;background-repeat:no-repeat;vertical-align:top;
          background-position:center;background-image:url('{{config('app.url')}}/images/emails/clients_financial_mobilen.png')"><!--{{config('app.url')}}-->
            <center style="padding-top:5px;padding-bottom: 18px">
              <a href="{{config('app.url')}}">
                <img src="{{config('app.url')}}/images/site-images/logo.png" width="159" /></a><!--{{config('app.url')}}-->
              </center>
              <div style="
      ...
      <tr>
        <td style="padding-top: 20px;background:#43425D;">
            <div style="font-size:18px; text-align: center;font-weight: 600;color:#FFFFFF;">Career Advice You Need To Hear</div>
          </div>
        </td>
      </tr>
      <tr>
        <td style="background:#43425D; padding: 15px 20px 5px 20px">
          <div style="line-height: 24px; text-align: center; font-size: 16px; color:#FFFFFF;max-width: 550px; margin: 0 auto">
            Let our psychics guide you to achieve financial independence.
          </div>
        </td>
      </tr>
      <tr>
