      ...
      <tr>
        <td style="text-align: center; background:#EFF6FF">
            <div style="line-height: 1.5;margin:auto; margin-top: 30px; text-align: center;  font-family: 'Montserrat', 'Verdana', sans-serif; font-size: 16px; color:#656B72; max-width: 550px; padding: 0px 15px">
              In order to ensure Psychics1on1 is lucrative for you and a great experience for clients, here’s the basics:
            </div>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td
          ...
          <div style="height: 38px;">
            ...
            href="https://psychics1on1.zendesk.com/hc/en-us/articles/360045794071-Online-Offline-Response-Time-Rules-" target="blank">
            Full Details
          </a>
           <!--<![endif]--> 
            <!--[if gte mso 9]>
                 <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://psychics1on1.zendesk.com/hc/en-us/articles/360045794071-Online-Offline-Response-Time-Rules-" style="height:38px;v-text-anchor:middle;width:120px;" arcsize="60%" opacity="0" stroke="f" fillcolor="#43425D">
                  <w:anchorlock/>
      ...
      <tr>
        <td
          ...
          <div style="margin:auto; text-align: center;  font-family: 'Montserrat', 'Verdana', sans-serif; font-size: 14px; font-weight: 600; color:#FFFFFF; max-width: 550px; padding: 10px 15px">
            <a target="blank" style="color: #FFFFFF; font-family: 'Montserrat', 'Verdana', sans-serif;" href="https://psychics1on1.zendesk.com/hc/en-us/articles/360045794071-Online-Offline-Response-Time-Rules-">Tap Here to Visit Our Help Center for Tips!</a>
        </div>
        </td>
      </tr>
      <tr>
