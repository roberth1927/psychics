...
<div class="homepage">
    <div class="pa-0">
      <v-img
        ...
        aspect-ratio="1"
        class="align-sm-center justify-sm-center imgHoroscopeHome"
      >
        <div class="justify-center text-center home_search" style="position: absolute;width: 100%;margin-top: -50px;padding: 0 47px;top: 45%;">
          <h1 class="horoscope_h1">Horoscope Signs</h1>
