...
@section('metas')
@parent
<link rel="canonical" href="https://www.psychics1on1.com/about">
<meta name="keywords" content="first psychic reading">
<meta name="description" content="Enjoy $5 off your first psychic reading with a spirtual advisor when you sign up today!">
@endsection
@section('title', 'About | Connect to Online Psychics | ')
@section('content')
<home-top></home-top>
                ...
                <div class="thirdSecContainer">
                    ...
                    <div class="itemContainer">
                        ...
                        <div class="itemContent">
                            ...
                            <p>Our growing gallery of Psychics, Mediums, Healers and Astrologers offers everything you’re looking for – from spiritual readings to relationship guidance to dream interpretation and horoscope navigation. It’s all here.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="thirdSectionHeading thirdSectionHeading-about pt-5 pb-5" style="background: #fff">
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="thirdSectionHeadingContainer">
                    <h2 style="padding-bottom: 30px">Psychic Advice Exactly When You Need It</h2>
                    <p  class="textMobAbout">
                        ...
                        <br><br>
                        Thanks to Psychics1on1’s™ simple upfront rates and $5 off your first reading with any of the thousands of spiritual advisors in our network, finding the clarity you need to tackle life’s biggest hurdles is just a click away.
