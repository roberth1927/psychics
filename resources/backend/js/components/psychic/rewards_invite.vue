            ...
            <div class="form-row mb-0 ml-0 mr-0">
              <div class="col-12 subtitle-1 m-0 p-0">
                ...
                <p class="sfProfileText" style="margin-top: 20px !important">
                  Invite friends and family who are new to Psychics1on1 via email and track signups and purchases from your Referrals tab. You can even send a reminder email.
                </p>
                <v-text-field
                  label="Email"
                  solo
                ...
                <span v-if="errors.referral_email " class="float-left text-danger small">
                 ...
                 <span v-if="msn" class="float-left text-danger small">
            ...
            <div class="form-row mb-0 ml-0 mr-0">
              <div class="col-12 subtitle-1 m-0 p-0">
                ...
                <p class="sfProfileText" style="margin-top: 20px !important">
                  ...
                  your Invite URL. Be sure to tag @psychics1on1 with your posts!
                </p>

                <p class="sfProfileTextSub">Instagram Graphics</p>
                <div class="form-row subtitle-1 m-0 p-0">
                  <box-download link="COSMIC_REWARDS_GRAPHIC_D_IG_1080x1080.png"></box-download>
                  <box-download link="COSMIC_REWARDS_GRAPHIC_C_IG_1080x1080.png" margin="0px 0px"></box-download>
                  <box-download video="COSMIC_REWARDS_GRAPHIC_A_ALL_1080x1080.mp4"></box-download>
                </div>
                <p class="sfProfileTextSub">Facebook Graphics</p>
                <div class="form-row subtitle-1 m-0 p-0" style="display: flex">
                  <box-download link="COSMIC_REWARDS_GRAPHIC_D_FB_1200x630.png"></box-download>
                  <box-download link="COSMIC_REWARDS_GRAPHIC_C_FB_1200x630.png" margin="0px 0px"></box-download>
                  <box-download video="COSMIC_REWARDS_GRAPHIC_A_ALL_1080x1080.mp4"></box-download>
                </div>
                <p class="sfProfileTextSub">Twitter Graphics</p>
                <div class="form-row subtitle-1 m-0 p-0" style="display: flex">
                  <box-download link="COSMIC_REWARDS_GRAPHIC_D_TW_1200x675.png"></box-download>
                  <box-download link="COSMIC_REWARDS_GRAPHIC_C_TW_1200x675.png" margin="0px 0px"></box-download>
                  <box-download video="COSMIC_REWARDS_GRAPHIC_A_ALL_1080x1080.mp4"></box-download>
                </div>
              </div>
            </div>
      ...
      axios
        ...
        .catch((error) => {
          if (error.response.status == 422) {
            ...
            this.msn = error.response.data.message;
          }
        });
    },
    share(type) {
      ...
      if (type == "facebook") {
        ...
        window.open(
          "https://twitter.com/share?url=https://www." + this.url_copy,
          "width=500,height=500,top=" + top + ",left=" + left + ""
        );
      } else if (type == "linkedin") {
        window.open(
          "https://www.linkedin.com/shareArticle?mini=true&url=https://www." +
            this.url_copy,
          "width=500,height=500,top=" + top + ",left=" + left + ""
        );
      }
