...
Vue.component(
  "p-analytics-earnings",
  require("./components/psychic/analystic_earnings.vue").default
);
Vue.component(
  "p-analytics-net-income",
  require("./components/psychic/analytics_net_income.vue").default
);
Vue.component(
  "p-header-data",
